...
-- Create simplified supervisor authentication function (similar to employee auth)
...
BEGIN
  ...
  -- Create auth user with email confirmation (similar to employee auth)
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Create fresh auth entry with minimal required fields
      INSERT INTO auth.users (
        id,
        instance_id,
        aud,
