...
DROP POLICY IF EXISTS "supervisor_employee_access_v1" ON employee_profiles;
...
CREATE POLICY "allow_all_supervisor_operations"
...
CREATE POLICY "allow_supervisor_employee_access"
