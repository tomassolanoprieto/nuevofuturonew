...
SELECT 
    ...
    document_type,
    document_number,
    delegation::text as delegation_text,
    pin,
    employee_id,
    created_at,
    updated_at,
...
SELECT 
    ...
    CASE 
        ...
        ELSE eb.delegation_text::delegation_enum
    END,
    eb.pin,
    eb.employee_id,
    eb.created_at,
    ...
    ARRAY(
        ...
        FROM regexp_split_to_table(eb.work_centers_text, ',') wc
    ...
    ARRAY(
        SELECT DISTINCT 
            CASE 
                ...
                ELSE wc
            END::work_center_enum
        FROM regexp_split_to_table(sb.work_centers_text, ',') wc
        WHERE wc != 'PROFESIONALES'
    ),
    ARRAY(
        SELECT DISTINCT 
            ...
            END
        FROM regexp_split_to_table(sb.delegations_text, ',') d
